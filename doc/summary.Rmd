...
if(file.exists(final.file) && !file.exists("Units.rds")){
  squares<-readRDS( "../squares.RDS")
  damage.bbox<-readRDS("../damage.bbox.rds")
  final.nodes.binded <- st_read(final.file)
...
saveRDS(Units,"Units.rds")
  ...
  mapview(Units, alpha = 0, zcol = "dmg_wCv" )
} 
